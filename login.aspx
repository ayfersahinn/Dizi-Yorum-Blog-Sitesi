<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="diziYorumSitesi.login" %>
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" runat="server">
					...
					<div class="container-login100-form-btn">
						<asp:Button ID="Button1" runat="server" Text="Giriş" CssClass="login100-form-btn" OnClick="btnGiris" />
					...
					<div class="text-center p-t-12">
						...
						<asp:HyperLink ID="HyperLink1" NavigateUrl="~/sifremiUnuttum.aspx" runat="server" CssClass="txt2">Şifremi Unuttum</asp:HyperLink>
						<%--<a class="txt2" href="#">
							Şifremi Unuttum
						</a>--%>
					</div>
